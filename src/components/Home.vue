  ...
  <v-layout row wrap>
        ...
        <v-card-title primary-title>
          <div>
            ...
            <span class="grey--text">
              2016 ‧ Science fiction film/Action
              fiction ‧ 3h 3m
            </span>
          </div>
        </v-card-title>
      ...
      <v-card>
        <v-card-title primary-title>
          <div>
            ...
            <span class="grey--text">
              2017 ‧ Drama/Science fiction film ‧ 2h
              21m
            </span>
          </div>
        </v-card-title>
    ...
    <v-flex xs4>
      <v-card>
        ...
        <v-card-text>
          In May 1940, Germany advanced into France, trapping Allied troopson the beaches of Dunkirk. Under air and ground cover from British and
